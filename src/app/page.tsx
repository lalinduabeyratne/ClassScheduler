import { BackgroundControls, BackgroundLayer, BackgroundSelectorProvider } from "./_components/BackgroundSelector";
import { ThemeToggle } from "./_components/ThemeToggle";

export default function HomePage() {
  return (
    <BackgroundSelectorProvider>
          ...
          <div className="relative mx-auto grid w-full max-w-6xl items-center justify-center gap-10 md:grid-cols-[1.15fr_0.85fr]">
            <div>
              ...
              <h1 className="mt-4">
                ...
                <span className="block text-2xl font-bold text-cyan-200 drop-shadow-[0_2px_4px_rgba(0,0,0,0.6)] dark:drop-shadow-none dark:text-cyan-200 md:text-4xl">
                  Physics Academy
                </span>
              </h1>
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                ...
                <BackgroundControls variant="mobile" />
              </div>
            ...
            <BackgroundControls variant="desktop" />
          </div>
        </section>
